          ...
          >
            ...
            <div className="p-6">
              <div className="text-center mb-6">
                <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-indigo-100 to-purple-100 dark:from-indigo-900 dark:to-purple-900 rounded-full mb-4">
                  <SparklesIcon className="h-10 w-10 text-indigo-600 dark:text-indigo-400" />
                </div>
