            ...
            <div className="p-6">
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900 dark:text-white">Choose Your Occasion</h3>
                    <p className="text-sm text-gray-600 dark:text-gray-400">
                      Pick from birthdays, anniversaries, congratulations, and more
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900 dark:text-white">Add Personal Details</h3>
                    <p className="text-sm text-gray-600 dark:text-gray-400">
                      Include recipient's name, your relationship, and special memories
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900 dark:text-white">Get Perfect Wishes</h3>
                    <p className="text-sm text-gray-600 dark:text-gray-400">
                      AI creates personalized, heartfelt messages you can edit and save
                    </p>
                  </div>
                </div>
              </div>
